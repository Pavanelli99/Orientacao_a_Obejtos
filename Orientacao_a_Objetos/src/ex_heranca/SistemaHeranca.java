...
public class SistemaHeranca {
    ...
    private static List<ReceberEmp> recEmprestimos = new ArrayList<ReceberEmp>();
    ...
    private static void escolha (int op){
        switch(op){
            ...
            //Receber Emprestimo
            case 6:
            ReceberEmp  novoReceberEmp  = ReceberEmp.cadastrarReceberEmp ();
            System.out.println("\nDevolução Cadastrada");
            System.out.println(novoReceberEmp .toString());
            recEmprestimos.add(novoReceberEmp);
             break;
